      ...
      <div className='bg-[#211B2C]'>
        ...
        >
          <p className='text-white text-[13px] opacity-[0.92]'>
            <span>{`© ${new Date().getFullYear()}, This application was developed by Switch. All rights and licenses are reserved. `}</span>
            <span>{` by `}</span>
            <Link href='https://www.switch.cl/' target='_blank' className='font-medium text-white'>
              Switch
            </Link>
          </p>
